...
class ViewEditarAlmacen(QDialog, Messages):
    ...
    def setupUi(self, Dialog):
        ...
        self.populateInputs()
        self.buttonBox.accepted.connect(self.updateWarehouse)
    ...
    def populateInputs(self):
        data = self._controller.select_warehouse_by_id(self.warehouse_id)
        self.txt_nombre.setText(data[1])
        self.txt_descripcion.setText(data[2])
        self.txt_ubicacion.setText(data[3])
    ...
    def updateWarehouse(self):
        ...
        self._controller.update_warehouse(name, description, location, self.warehouse_id)
