...
class viewListaCategorias(QWidget, Messages):
    ...
    def setupUi(self, Dialog):
        ...
        headers = ['Categoría', 'Nombre', 'Descripción', 'Cantidad', 'Fecha Ingreso', 'Vida Útil', 'Estatus']
        keys = ['categoria_producto', 'nombre_producto', 'descripcion', 'cantidad', 'fecha_ingreso', 'vida_util', 'estatus']
