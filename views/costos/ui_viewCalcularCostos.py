...
class ViewCalcularCostos(QDialog, Messages):
    ...
    def retranslateUi(self, Dialog):
        if self.tipo == "costo semivariable":
        ...
        elif self.tipo == "costo de conversión":
